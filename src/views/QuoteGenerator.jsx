...
import { Calculator, Ship, DollarSign, Download, MapPin, Globe, FileText } from 'lucide-react';
...
const QuoteGenerator = ({ role }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 pb-12 animate-fade-in">
      {/* Formulario */}
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-y-auto flex flex-col">
        <div className="p-6 flex-1">
          ...
          <div className="mb-6 bg-slate-50 p-4 rounded-lg border border-slate-100">
            <h3 className="text-xs font-bold text-slate-400 uppercase mb-3">Datos generales</h3>
            ...
            {/* Datos operativos */}
            <h3 className="text-xs font-bold text-slate-400 uppercase mb-3 flex items-center mt-4">
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50">
          <button 
            ...
            className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-lg flex items-center justify-center transition-all"
          >
            <Download size={20} className="mr-2"/> Descargar PDF membretado
          </button>
        </div>
      </div>
      ...
      <div className="hidden lg:flex bg-slate-200 p-6 rounded-xl overflow-y-auto shadow-inner justify-center items-start">
        <div className="bg-white shadow-2xl w-full max-w-md relative flex flex-col font-sans text-slate-800 text-sm rounded-lg overflow-hidden">
          {/* Header */}
