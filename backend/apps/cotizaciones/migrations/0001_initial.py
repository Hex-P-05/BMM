    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puerto', models.CharField(default='MANZANILLO', max_length=100, verbose_name='Puerto')),
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cotizaciones', to=settings.AUTH_USER_MODEL, verbose_name='Creado por')),
            ],
            options={
